...
var Carousel = React17.forwardRef((uncontrolledProps, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    bsPrefix,
...
var DropdownItem2 = React25.forwardRef(({
  ...
  return (0, import_jsx_runtime25.jsx)(Component2, {
    ...
    ...dropdownItemProps,
    ref,
    className: (0, import_classnames16.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
var DropdownMenu2 = React27.forwardRef(({
  ...
  return (0, import_jsx_runtime26.jsx)(Component2, {
    ...
    className: (0, import_classnames17.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
var DropdownToggle2 = React28.forwardRef(({
  ...
  return (0, import_jsx_runtime27.jsx)(Component2, {
    className: (0, import_classnames18.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return (0, import_jsx_runtime28.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime28.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime28.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames19.default)(className, show && "show", directionClasses[drop])
      })
    })
  });
});
...
var Feedback = React31.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormContext = React32.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime32 = __toESM(require_jsx_runtime());
var FormCheckInput = React33.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React34.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React35.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
var FormControl = React36.forwardRef(({
  ...
  return (0, import_jsx_runtime37.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames24.default)(className, classes, isValid && `is-valid`, isInvalid && `is-invalid`, type === "color" && `${bsPrefix}-color`)
  });
});
...
var FormGroup = React37.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
FormLabel.defaultProps = defaultProps11;
...
var FormRange = React39.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React40.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React41.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React42.forwardRef((props, ref) => (0, import_jsx_runtime43.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React43.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
Image.defaultProps = defaultProps12;
...
FigureImage.defaultProps = defaultProps13;
...
var ModalDialog = React50.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
ModalHeader.defaultProps = defaultProps14;
...
var Modal = React52.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime54.jsx)("div", {
    ...backdropProps,
...
Modal.defaultProps = defaultProps15;
...
Popover.defaultProps = defaultProps16;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime62.jsxs)(import_jsx_runtime61.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react36.cloneElement)(children, triggerProps), (0, import_jsx_runtime60.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Pagination = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames43.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames44.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
Ratio.defaultProps = defaultProps21;
...
Tabs2.defaultProps = defaultProps23;
...
ToastHeader.defaultProps = defaultProps24;
...
var ToastContainer = React80.forwardRef(({
  ...
  return (0, import_jsx_runtime88.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames54.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
ToggleButtonGroup.defaultProps = defaultProps25;
